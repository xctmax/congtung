        ...
        def run(self):
            ...
            while True:
                try:
                    ...
                    sys.stdout.write(Fore.RED + '[+] Host Die or Proxy Die !!!\n')
...
──────────────────────────────────────────────────────────────────────────────────────────────────────────''')
            ...
            try:
                ...
                while choice == 'high anonymous http/https/sock4/sock5':
                    choice = str(input('[*]Chọn loại Proxy[http/https/sock4/sock5]: ')).strip()
                    if choice == 'http':
                    ...
                    if choice == 'sock5':
                        ...
                        print(Fore.YELLOW + '[+] Có Tổng Socks5 Proxies: %s . ' % len(proxies_socks5))
